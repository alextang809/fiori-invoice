		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "iLMS Course Booking System",
									"targetURL": "#ypoccourseypoccourse-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ypoccourseypoccourse-display": {
								"semanticObject": "ypoccourseypoccourse",
								"action": "display",
								"description": "iLMS Course Booking System",
								"title": "iLMS Course Booking System",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ypoc.course.ypoccourse",
									"url": sap.ui.require.toUrl("ypoc/course/ypoccourse")
								}
							}
						}
					}
